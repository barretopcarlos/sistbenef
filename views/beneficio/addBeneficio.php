<?php Acl::view('beneficio/addBeneficio');?>
    ...
    <body>  
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><span class="text-breadcrumb-blue texto-breadcrumb"><a href="<?= url_for('/beneficio/cadastrarBeneficio'); ?>">Cadastro de Novos Benefícios</a></span></li>
            </ol>
        </nav>

            <div class="container" style="margin-bottom: 100px;">
                <?php if ($msg == true) : ?>
                    <div class="beneficio-cadastrado">
                        <i class="bi bi-check-circle-fill"></i>
                        <p class="texto-beneficio-cadastrado">Benefício <?php echo $_POST['tipoBeneficio']; ?> cadastrado com sucesso.</p>
                    </div>
                <?php else : ?>
                    <div class="beneficio-nao-cadastrado">
                        <i class="bi bi-exclamation-circle-fill"></i>
                        <p class="texto-beneficio-nao-cadastrado">Não foi possível cadastrar o benefício. Já existe um benefício com esse nome.</p>
                    </div>
                <?php endif; ?>
            </div>
