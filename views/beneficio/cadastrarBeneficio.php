<?php Acl::view('beneficio/cadastrarBeneficio');?>
    ...
    <body>  
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><span class="text-breadcrumb-blue texto-breadcrumb">Cadastro de Novos Benefícios</span></li>
            </ol>
        </nav>
        ...
        <h1>Cadastro de Novos Benefícios</h1>

        <form action="<?= url_for('beneficio/cadastrarBeneficio'); ?>" method="POST" id="cadastroBeneficio">

            <!-- <input type="hidden" name="id_beneficio" value="" id="id_beneficio"> -->
                
            <div class="row conteudo-form">

                <div class="col-4 beneficio-input">
                    <label for="">Novo Benefício:</label>
                    <input type="text" class="form-control" name="tipoBeneficio" value="" id="tipoBeneficio" maxlength="50" placeholder="Digite o nome do novo benefício" required>
                </div>

                <div class="col-2 dialimite-input">
                    <label for="diaLimite">Dia Limite da Entrega:</label>
                    <select class="form-select" name="diaLimite" id="diaLimite" required>
                        <option class="selecao" value="">Selecione o dia</option>
                        <?php
                            for ($i = 1; $i <= 31; $i++) {
            ...
            <div class="row conteudo-form">
                ...
                <div class="col-2 radio-input">
                    <div>
                        <label for="tipoOpcao">Teto de Gasto:</label>
                    </div>
                    <div class="d-flex">
                        <div class="form-check me-3">
                            <input class="form-check-input" type="radio" name="tetoGasto" id="tetogastoS" value="Sim" required checked>
                            <label class="form-check-label" for="tetoGasto">Sim</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="tetoGasto" id="tetoGastoN" value="Não">
                            <label class="form-check-label" for="tetoGasto">Não</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-2 radio-input">
                    <div>
                        <label for="tipoOpcao">Reembolsável:</label>
                    </div>
                    <div class="d-flex">
                        <div class="form-check me-3">
                            <input class="form-check-input" type="radio" name="reembolso" id="reembolsoS" value="Sim" required checked>
                            <label class="form-check-label" for="reembolso">Sim</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="reembolso" id="reembolsoN" value="Não">
                            <label class="form-check-label" for="reembolso">Não</label>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <span class="label-content-modal">Novo Benefício</span><br>
                        <p id="modalTipoBeneficio"></p>

                        <span class="label-content-modal">Dia Limite da Entrega</span><br>
                        <p id="modalDiaLimite"></p>    

                        <span class="label-content-modal">Teto de Gasto</span><br>
                        <p id="modalTetoGasto"></p>    

                        <span class="label-content-modal">Reembolsável</span><br>
                        <p id="modalReembolso"></p>

                        <span style="text-align: left;display:block;">Deseja prosseguir com o cadastro do novo benefício?</span>
                    </div>
...
<!-- Js da página -->
<script src="assets/js/beneficio/cadastrar_beneficio.js"></script>