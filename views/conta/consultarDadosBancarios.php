<?php Acl::view('beneficio/consultarDadosBancarios');?>

<html >
    <body>  
        <?php
            $formattedData = [];
            foreach ($dadosBancarios as $conta) {
                $formattedData[] = [
                    'id' => $conta->id,
                    'codigo_banco' => $conta->banco_beneficio,
                    'nome_banco_beneficio' => $conta->nome_banco_beneficio,
                    'agencia' => $conta->agencia_beneficio,
                    'conta_corrente' => $conta->conta_beneficio,
                    'banco_pagamento' => $conta->banco_pagamento,
                    'nome_banco_pagamento' => $conta->nome_banco_pagamento,
                    'agencia_pagamento' => $conta->agencia_pagamento,
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><span class="text-breadcrumb-blue texto-breadcrumb">Visualizar Informações Bancárias</span></li>
            </ol>
        </nav>

        <h1>Visualizar Informações Bancárias</h1>

        <table id="beneficioTable" class="display">
            <thead>
                <tr>
                    <th>id</th>
                    <th>Cód. Banco Benefício</th>
                    <th>Banco Benefício</th>
                    <th>Agência Benefício</th>
                    <th>Conta Benefício</th>
                    <th>Cód. Banco Pagamento</th>
                    <th>Banco Pagamento</th>
                    <th>Agencia Pagamento</th>
...
<!-- CSS da Página -->
<link href="assets/css/conta/conta.css" rel="stylesheet" >
<!-- Js da página -->
<script src="assets/js/conta/conta.js"></script>